...
exports.handleComment = {
    ...
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const comments = yield models_1.default.Comment.findAll({
          ...
          attributes: ["content"],
          include: [
            { model: models_1.default.User, attributes: ["avatar", "email"] },
          ],
          separate: true,
        });
        return {
  ...
  addComment: (data) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const newComment = yield models_1.default.Comment.create(
          Object.assign({}, data)
        );
        return {
