...
route.put('/movies', upload_1.default.fields(([{ name: 'avatar' }, { name: 'video' }, { name: 'trailler' }])), handleFileUpload_1.handleUploadFile, controller_1.ControllerMovie.updateMovies);
